[getopts - v1.0.0-beta.3](../README.md) / [interfaces/schema](../modules/interfaces_schema.md) / ArgFilter
...
Defined in: [src/interfaces/schema.ts:4](https://github.com/prasadrajandran/node-getopts/blob/11bb392/src/interfaces/schema.ts#L4)
